...
var dogHouse = function(top, left, timeNotUsed) {
  ...
  this.$node.append('<img class="dogHouseImage" src=http://yanhe.me/wp-content/uploads/doghouse-png-clip-art-2572-clipart-of-dog-house.png>')
  this.left = left;
  this.top = top;
};
...
dogHouse.prototype.lineUp = function(timeNotUsed) {
};
